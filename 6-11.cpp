...
TCHAR szSize[MAX_PATH];
 ...
 std :: cout.fill ('0') ;
 std :: cout
 << std :: hex << std :: setw(8) << (uintptr_t ) pBlock
 << "-"
 << std :: hex << std :: setw(8) << (uintptr_t ) pEnd
...
void ShowVirtualMemory()
{
 ...
 uintptr_t  dwMemSize = (uintptr_t )si.lpMaximumApplicationAddress -
